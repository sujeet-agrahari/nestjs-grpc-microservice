...
export interface UserServiceClient {
  ...
  fineOneUser(request: FindOneUserDto): Observable<User>;
...
export interface UserServiceController {
  ...
  fineOneUser(request: FindOneUserDto): Promise<User> | Observable<User> | User;
...
export function UserServiceControllerMethods() {
  return function (constructor: Function) {
    const grpcMethods: string[] = ["createUser", "findAllUsers", "fineOneUser", "updateUser", "removeUser"];
